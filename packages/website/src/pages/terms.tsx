    ...
    <Layout>
      ...
      <main className='h-full container mx-auto xl:px-72 lg:px-36 px-4'>
        <div
          ...
          id='en'
        >
          <h1 className='text-center mb-12'>Terms and Conditions</h1>
          ...
          <h3 className='my-2'>Acknowledgment</h3>
          <p>
          ...
          <h3 className='my-2'>Termination</h3>
          <p>
          ...
          <h3 className='my-2'>"AS IS" and "AS AVAILABLE" Disclaimer</h3>
          <p>
          ...
          <h3 className='my-2'>Governing Law</h3>
          <p>
          ...
          <h3 className='my-2'>Disputes Resolution</h3>
          <p>
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <h3 className='my-2'>For European Union (EU) Users</h3>
          <p>
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which you are
            resident in.
          </p>
          <h3 className='my-2'>United States Legal Compliance</h3>
          <p>
          ...
          <h3 className='my-2'>Severability and Waiver</h3>
          ...
          <h3 className='my-2'>Translation Interpretation</h3>
          <p>
            These Terms and Conditions may have been translated if We have made
            them available to You on our Service. You agree that the original
            English text shall prevail in the case of a dispute.
          </p>
          <h3 className='my-2'>Changes to These Terms and Conditions</h3>
          <p>
