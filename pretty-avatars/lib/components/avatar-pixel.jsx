...
function generateColors(name, colors) {
    ...
    var colorList = Array.from({ length: ELEMENTS }, function (_, i) {
        return getRandomColor(numFromName % i, colors, range);
    });
    return colorList;
}
var AvatarPixel = function (props) {
    var pixelColors = generateColors(props.name, props.colors);
    return (<svg viewBox={'0 0 ' + SIZE + ' ' + SIZE} fill='none' role='img' xmlns='http://www.w3.org/2000/svg' width={props.size} height={props.size}>
      ...
      <mask id='mask__pixel' mask-type='alpha' maskUnits='userSpaceOnUse' x={0} y={0} width={SIZE} height={SIZE}>
