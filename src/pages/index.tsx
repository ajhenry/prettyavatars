            ...
            <div className='flex min-h-screen flex-col items-center justify-center'>
              <div className=''>
                <h1 className='heading-1 mt-4 p-4 text-8xl font-extrabold'>
                  <span className='bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text font-black text-transparent'>
                    Pretty Avatars
                  </span>
                </h1>
              </div>
              <p className='mt-8 w-3/4 text-xl'>
                A collection of pretty avatars for your next project. All
                avatars are SVG-based and are generated based on the name and
                color palette you provide.
              </p>
